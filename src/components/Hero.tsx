  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h1
          className="text-5xl md:text-8xl md:leading-tight font-black text-foreground max-w-xl md:max-w-2xl mx-auto text-red-700"
          style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)" }}
        >
          {heroDetails.heading}
        </h1>
        <h2 className="mt-4 md:text-xl font-bold text-foreground max-w-xl mx-auto">
